...
const OrderSuccess = () => {
  ...
  return (
    <div className="flex flex-col items-center bg-gray-100 p-10">
      <CheckCircleFilled className="text-green-500 text-[80px] mb-[15px]" />
      <p className="text-[40px] font-bold mb-[10px]">Cảm ơn đã mua hàng</p>
      <p className="text-[18px] mb-[5px]">
        Đơn hàng của bạn sẽ được vận chuyển trong 5 - 7 ngày.
      </p>
      ...
      <div className="max-w-[500px] bg-white w-full p-5 mb-5">
        ...
        <div className="flex flex-col gap-4">
          {orderData.orderItems.map((item, index) => (
            ...
            >
              <img src={item?.product?.image} alt="" className="size-[80px]" />
